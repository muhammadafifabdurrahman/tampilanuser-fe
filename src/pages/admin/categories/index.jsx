                  ...
                  <tr key={categori.id} className="border-b dark:border-gray-700">
                    ...
                    {openDropdownId === categori.id && (
                      ...
                      >
                        ...
                        <div className="py-1">
                            <button onClick={ ()=> handleDelete(categori.id)}  className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Delete</button>
                        </div>
                      </div>
                    )}
                    </td>
